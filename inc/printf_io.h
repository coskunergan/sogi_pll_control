...
namespace device_printf
{
    ...
    GpioOutput lcd_rst_pin(GPIOC, GPIO_Pin_5, true);
    GpioOutput lcd_clk_pin(GPIOB, GPIO_Pin_2);
    GpioOutput lcd_dta_pin(GPIOB, GPIO_Pin_14);
    GpioOutput lcd_cmd_pin(GPIOB, GPIO_Pin_1);
    GpioOutput lcd_enb_pin(GPIOB, GPIO_Pin_13, true);
    GpioOutput lcd_bl_pin(GPIOB, GPIO_Pin_0, true);
